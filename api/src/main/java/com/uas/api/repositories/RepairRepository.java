...
public interface RepairRepository extends JpaRepository<Repair, Long> {
     ...
     */
    @Query(value = "SELECT sum(cost) FROM Repairs WHERE AircraftPart.PartNumber= ANY (SELECT PartNumber FROM parts WHERE AircraftTailNumber=:tailNumber)", nativeQuery = true)
     ...
     */
    @Query(value = "SELECT sum(cost) FROM Repairs WHERE AircraftPart.PartNumber= ANY (SELECT PartNumber FROM parts)", nativeQuery = true)
